<?php
// ============================================================================
// ProjectPlayCore – Template Controller (dezentralisiert)
// Pfad: /backend/modules/template/controller.php
// ============================================================================
...
// ============================================================================
// Settings-Dateien lesen und schreiben
// ============================================================================
...
switch ($action) {
    case 'about':
        ...
        <!doctype html><html lang="de"><head>
            ...
            <ul>
                <li><a href="/backend/modules/<?=$moduleName?>/controller.php?action=settings">Einstellungen</a></li>
            </ul>
        </body></html>
        <?php
        break;
