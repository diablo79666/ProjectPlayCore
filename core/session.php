<?php
// ============================================================================
// ProjectPlayCore – Session-Verwaltung
// Pfad: /backend/core/session.php
// Beschreibung:
//  PHP-Sessions mit sicherem Speicherort, Cookie-Parametern, ID-Regeneration,
//  Login-Helfern und Admin-Funktionsprüfung.
// ============================================================================
...
// Session-ID sicher neu generieren
...
if (!function_exists('ppc_current_user')) {
    function ppc_current_user(): ?string {
        return isset($_SESSION['ppc_user'])
            ? (string)$_SESSION['ppc_user']
            : null;
    }
}

// Alte Login-Prüfung – leitet auf /user/login.php
...
// Neue Login-Prüfung – leitet auf /frontend/login.php
if (!function_exists('ppc_require_login_redirect')) {
    function ppc_require_login_redirect(): void {
        if (session_status() !== PHP_SESSION_ACTIVE) {
            @session_start();
        }
...
// ---------------------------------------------------------
// Admin-Funktionsprüfung – Diagnose für Dashboard / Tools
// ---------------------------------------------------------
if (!function_exists('ppc_session_diagnostics')) {
    /**
     * Liefert ein Array mit Statusinfos zum Session-System.
     * Kann im Admin-Dashboard angezeigt werden.
     */
    function ppc_session_diagnostics(): array {
        $status = [
            'session_active' => (session_status() === PHP_SESSION_ACTIVE),
            'session_path'   => session_save_path(),
            'current_user'   => $_SESSION['ppc_user'] ?? null,
            'functions' => [
        ...
        $status['ok'] = (
            ...
            $status['functions']['ppc_require_login_redirect'] &&
